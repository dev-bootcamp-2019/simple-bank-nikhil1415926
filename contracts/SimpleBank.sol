...
contract SimpleBank {
    ...
    function enroll() public returns (bool _Status){
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        ...
        require (balances[msg.sender] >= withdrawAmount,"balance should be greater than or equal to withdrawal");
    ...
    function() external {
        revert("invalid data transaction will be reverted");
    }
}
